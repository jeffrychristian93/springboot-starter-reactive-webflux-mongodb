...
public class SwaggerConfiguration {
  ...
  public Docket docket() {
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.programmingdarinol.your_service_name.controller"))
        .paths(regex("/.*"))
        .build()
        ...
        .apiInfo(new ApiInfoBuilder()
            ...
            .build())
        .genericModelSubstitutes(DeferredResult.class, ResponseEntity.class, Mono.class);
  }
